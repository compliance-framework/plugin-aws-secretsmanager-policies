package compliance_framework.secretsmanager_admin_principal_present_test

import data.compliance_framework.secretsmanager_admin_principal_present as policy
...
test_service_linked_skipped if {
	inp := json.patch(base_secret, [{"op": "replace", "path": "/config/owning_service", "value": "rds.amazonaws.com"}, {"op": "replace", "path": "/config/resource_policy/principals/0/action", "value": ["secretsmanager:GetSecretValue"]}])
	count(policy.violation) == 0 with input as inp
}
