package compliance_framework.secretsmanager_scheduled_deletion_window_test

import data.compliance_framework.secretsmanager_scheduled_deletion_window as policy
...
test_minimum_fails if {
	inp := json.patch(base_secret, [{"op": "replace", "path": "/config/deleted_date", "value": "2026-05-20T00:00:00Z"}, {"op": "replace", "path": "/config/recovery_window_days", "value": 3}])
	policy.violation[{"id": "recovery_window_below_minimum"}] with input as inp
}
